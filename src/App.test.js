...
//     let newResponse= response.data.daily.slice(1, 6);
//     setForecast({
//       minTemperature: Math.round(newResponse.temperature.minimum),
//       maxTemperature: Math.round(newResponse.temperature.maximum),
//       description: response.data.condition.description,
//       humidity: newResponse.temperature.humidity,
//       icon: response.data.condition.icon_url,
//       icon_descr: response.data.condition.icon,
//     });
//     // let updatedResp= response.data.daily.slice(1, 6);
//     // console.log(updatedResp);
//     // if (updatedResp) {
//     //   setForecast({
//     //     ...forecast,
//     //     // timestamp: ,
//     //     temperature: convertTemperature(response.temperature, units),
//     //     feels_like: convertTemperature(response.feels_like, units)
//     //   });
//   }

//   function getForecast(query) {
//     const apiKey = "9422f0o3bf27abc2b46fcabt0cf2c5f3";
...
//       return;
//     }
//     let url = `https://api.shecodes.io/weather/v1/current?query=${query}&key=${apiKey}&units=metric&t=${new Date().getTime()}`;
//     axios.get(url)
//       .then((response) => {
...
//       });
//     }, [apiKey, updateWeather]);
  
//   // ---------------------------------------------------Search Current City Location Weather
//   const getCurrentLocation = useCallback(() => {
//     if (navigator.geolocation) {
//       navigator.geolocation.getCurrentPosition(
//         (position) => {
//           const { latitude, longitude } = position.coords;
//           let url = `https://api.shecodes.io/weather/v1/current?lon=${longitude}&lat=${latitude}&key=${apiKey}&units=metric&t=${new Date().getTime()}`;
...
//     }
//   }, [apiKey, updateWeather, searchCity]);
